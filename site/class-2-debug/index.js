...
var width = 960 - margin.left - margin.right; // alleen een letter kan niet, dit moet voluit geschreven worden.
...
var xAxis = d3.axisBottom(x); // https://iros.github.io/d3-v4-whats-new/#43
...
function onload(data) {
   ...
   y.domain(d3.extent(data, sepalLength)).nice(); // https://github.com/d3/d3-array/blob/master/README.md#extent

...
/* Define margins and size — https://bl.ocks.org/mbostock/3019563. Changed margin-l, margin-r, margin-t and margin-b */
var margin = {top: 48, right: 48, bottom: 48, left: 48};
var width = 960 - margin.left - margin.right;
var height = 500 - margin.top - margin.bottom;

/* Scales and axes. Changed scale.linear, scale.ordinal, xAxis, yAxis*/
...
/* Load data. Changed from tsv to csv*/
d3.csv('index.csv', row, onload);

/* Handle data. Changed extend*/

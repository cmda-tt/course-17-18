# Debugging
Debugged version of the code found [here](https://github.com/cmda-fe3x3/course-17-18/blob/master/class-2.md#style).
## Background
[This](https://github.com/cmda-fe3x3/course-17-18/blob/master/class-2.md#style) code has mostly been rewritten to my own prefered way of writing code.
## Code in Depth
